...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // PLUS DE VERIFICATION DE LOGIN ICI
    ...
    try {
        ...
        if(camp.inscription_en_ligne == 1 && places > 0) {
            ...
            if(isLoggedIn) {
                ...
                ctaHtml = `
                    ...
                    <p class="text-center text-xs text-gray-500 mt-2">Compte gratuit requis</p>`;
            }
        ...
        // BOUTON CONTACT (Seulement si connecté)
